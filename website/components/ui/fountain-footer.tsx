    ...
    <footer className="relative mx-auto flex w-full max-w-4xl flex-col items-center justify-center border-t border-white/10 bg-black px-6 py-12 text-white lg:py-16">
      <div className="flex flex-col items-center gap-6 text-center">
        <div className="flex items-center gap-3">
          <Image src="/Fountain%20PitchDeck.png" alt="Rayls" width={140} height={42} priority />
          <span className="sr-only">Rayls</span>
        </div>
        <p className="max-w-2xl text-sm text-white/60">
          We automate stablecoin issuance to accelerate real-world asset tokenization across Latin America with total

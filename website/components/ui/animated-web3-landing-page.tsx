...
export function Web3HeroAnimated() {
  ...
  const navLinks = [
    ...
    { label: "Docs", href: "https://docs-fountain-rayls.vercel.app/", external: true },
  ]
  ...
  const handleNavClick = (e: React.MouseEvent<HTMLAnchorElement>, href: string) => {
    if (href.startsWith('#')) {
      ...
      if (element) {
        const offset = 80 // Offset para compensar o header fixo
        ...
        <header className="relative z-10">
          <div className="mx-auto flex w-full max-w-7xl items-center justify-between px-6 py-6 md:px-8">
            ...
            <div className="hidden items-center gap-3 md:flex">
              <a
                href="https://api-fountain-rayls.vercel.app/"
                target="_blank"
        ...
        <div className="relative z-10 mx-auto grid w-full max-w-5xl place-items-center px-6 py-16 md:py-24 lg:py-28">
          <div className={`mx-auto text-center ${isMounted ? "animate-fadeInUp" : "opacity-0"}`}>
            <div className="flex flex-col items-center gap-3">
              <a
                href="https://rayls.network"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 rounded-full bg-white/5 px-3 py-1.5 text-[11px] uppercase tracking-wider text-white/70 ring-1 ring-white/10 backdrop-blur transition hover:bg-white/10 hover:text-white"
              >
                <span className="relative flex h-2 w-2 items-center justify-center">
                  <span className="absolute inline-flex h-full w-full rounded-full animate-pulse" style={{ backgroundColor: '#ECFB3E', animation: 'blink 1.5s ease-in-out infinite' }}></span>
                  <span className="relative inline-flex rounded-full h-2 w-2" style={{ backgroundColor: '#ECFB3E' }}></span>
                </span>
                Running on Rayls Mainnet
              </a>
            </div>
            <h1
            ...
            >
              Stablecoin factory for RWA
            </h1>
            <p
              style={{ animationDelay: "300ms" }}
              className={`mx-auto mt-5 max-w-2xl text-balance text-white/80 md:text-lg ${isMounted ? "animate-fadeInUp" : "opacity-0"}`}
            >
              Automate BRL-backed stablecoin issuance for real-world asset tokenizers. Secure, fast, and Rayls-native end
              to end.
            </p>
            <div
            ...
            >
              ...
              <a
                href="https://docs-fountain-rayls.vercel.app/"
                target="_blank"
                rel="noopener noreferrer"
